...
public class MortgageTests {
	...
	private Mortgage test = new Mortgage("", testAmount, testInterest, testYear, currentUser);
	...
	public void testLatePartialPay() {
		BankAccount account = new BankAccount(false, currentUser, 2000, 1);
	...
	public void testLateFullPay() {
		BankAccount acct2 = new BankAccount(false, currentUser, 3900, 1);
		// they have enough
	...
	public void testEarlyPartialPay() {
		BankAccount acct3 = new BankAccount(false, currentUser, 3900, 1);
		// they have enough
